...
---@param y number
---@param z number
function LuaPlayer.teleport(self, x, y, z) end
...
---@param other Vector3
---@return Vector3 @The updated vector
...
---@param y number
---@param z number
function LuaEntity.teleport(x, y, z) end

---Teleports the entity using a Vector3 table.
---@param vec Vector3
function LuaEntity.teleport(vec) end

---Returns the entity's current location.
---@return Vector3 @Entity position
function LuaEntity.getLocation() end

---Returns a list of entities nearby the entity.
---@param x number
---@param y number
---@param z number
---@return table @Array of LuaEntity tables
function LuaEntity.getNearbyEntities(x, y, z) end
