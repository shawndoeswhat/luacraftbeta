...
import com.shawndoeswhat.luacraftbeta.console.LuaConsoleBridge;
import com.shawndoeswhat.luacraftbeta.console.GuiConsoleManager;
import com.shawndoeswhat.luacraftbeta.lua.LuaBindings;
    ...
    public void executeScript(String scriptPath, String playerName, boolean debug) {
        ...
        try (FileReader reader = new FileReader(scriptFile)) {
            ...
            if (player != null && player.isOnline()) {
                luaPlayer = new com.shawndoeswhat.luacraftbeta.lua.api.LuaPlayer(player).toLuaTable();
            } else {
